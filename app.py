...
if app_mode == "Visualization":
    ...
    tab1, tab2, tab3, tab4, tab5 = st.tabs(["Average Insurance Charges by Region","Average BMI Charges by Region", "Average Charges by Age", "A Scatter Plot", "A Correlation Map" ])
